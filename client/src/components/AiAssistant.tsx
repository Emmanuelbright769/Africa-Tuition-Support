...
export function AiAssistant() {
  ...
  return (
    <>
      ...
      {/* Floating trigger — only visible when chat is closed */}
      <AnimatePresence>
        {!open && (
          <motion.div
