  ...
  return <Dialog open={open} onOpenChange={next => { if (!next) acknowledge(); }}>
    <DialogContent className="sm:max-w-sm">
      <DialogHeader>
        ...
        <DialogDescription>All outgoing payments are protected by a 4-digit transaction PIN instead of an emailed code. You can set it under SwiftWallet → Me → Security.</DialogDescription>
      </DialogHeader>
