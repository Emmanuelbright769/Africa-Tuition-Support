        ...
        <DialogContent className="sm:max-w-md" onInteractOutside={e => e.preventDefault()}>
          <DialogHeader>
            ...
            <DialogDescription className="text-sm leading-relaxed pt-2">
              Your account is ready. To unlock all TSIA features — wallet transactions, QCE SwiftVault, loans, TS-Mart Online Stores and more — please <strong>fund your SwiftWallet with above $5</strong>.
            </DialogDescription>
          </DialogHeader>
