            ...
            {activeSection === "wallet" && (
              <>
                <motion.div variants={itemVariants}>
                  ...
                  <p className="text-muted-foreground text-sm mb-6">Manage your TSIA balance and withdrawals.</p>
                </motion.div>
                <motion.div variants={itemVariants}>
                  <Card className="shadow-md border-0">
                    <CardContent className="pt-8 pb-8">
                      <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-6 mb-8">
                        ...
                        <Dialog open={withdrawOpen} onOpenChange={setWithdrawOpen}>
                          <DialogTrigger asChild>
                            <Button className="h-12 px-8 bg-blue-600 hover:bg-blue-700 shadow-md text-base font-semibold" disabled={balance <= 0} data-testid="button-withdraw">
                      ...
                      <div className="bg-amber-50/50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800 rounded-xl p-4 flex items-start gap-3 text-sm text-amber-800 dark:text-amber-300">
                        ...
                        <p>A mandatory <strong>7.5% VAT</strong> is applied to all withdrawals as required by Nigerian tax regulations.</p>
                      </div>
                    </CardContent>
                  </Card>
                </motion.div>
