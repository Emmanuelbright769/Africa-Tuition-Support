          ...
          <div className="space-y-12">
            ...
            <Section id="wallet" icon={CreditCard} title="7. Digital Wallet &amp; Payments">
              ...
              <Clause num="7.11" title="Monthly Platform Subscription and Maintenance">
                <p>Starting <strong>1 September 2026</strong>, a <strong>$1.50 monthly platform subscription fee</strong> and a <strong>$0.50 wallet maintenance fee</strong> are due on the <strong>1st of each calendar month</strong>. Each full $2.00 monthly charge is collected from the user's TSIA SwiftWallet. If the wallet cannot cover all outstanding monthly charges, no partial charge is taken and platform access is restricted to login, account status, identity verification, and wallet-funding channels. Any unpaid month remains due, and access is restored automatically only after all outstanding charges are successfully collected.</p>
              </Clause>
            </Section>
            ...
            <Section id="trade" icon={TrendingUp} title="8. Trade Market &amp; AI Investment Bot">
              ...
              <Clause num="8.5" title="Reserve Fund">
                <p>The strategic reserve fund is fed from trade deposits and applicable withdrawal fees. Users have no claim over the reserve fund, and it cannot be withdrawn.</p>
              </Clause>
