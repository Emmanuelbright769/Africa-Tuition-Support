...
export const transactionTypeEnum = pgEnum("transaction_type", ["verification_fee", "plan_payment", "sponsorship_credit", "withdrawal", "vat_deduction", "deposit", "transfer", "bill", "trade_transfer", "loan", "admin_credit", "admin_adjustment", "crypto_withdrawal"]);
